...
conn.send3ButtonImg(m.chat, pp, menu, '©Hanmilo Botᙆ  ᷦ×͜×', 'Creador', `#owner`, '𝐌𝐞𝐧𝐮 𝐀𝐮𝐝𝐢𝐨𝐬', `#menuaudios`, 'unir el bot a tu grupo🤳', `#join`, m, false, { contextInfo: { mentionedJid }})   
//await await await await await await conn.sendFile(m.chat, vn, 'mariana.mp3', true, m, true, {
//type: 'audioMessage', 
//ptt: true 
//})
}
