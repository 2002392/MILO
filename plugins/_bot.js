...
conn.sendButton(m.chat, `*Hola, como te puedo ayudar?*`, '©Danery hanma- Bot', '𝙼𝙴𝙽𝚄 𝙳𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾𝚂', `${usedPrefix}menu`, 'conversation', { sendEphemeral: true, quoted: estilo })
await conn.sendFile(m.chat, vn, 'bot.mp3', false, m, true, { type: 'audioMessage', ptt: true, sendEphemeral: false, quoted: estiloaudio })
}
