...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('18292077732@s.whatsapp.net', teks1, MessageType.text)
    //conn.sendMessage('18292077732@s.whatsapp.net', teks1, MessageType.text) // añade tu número aqui, pero no quites el otro. Quita las // del inicio de esta línea
