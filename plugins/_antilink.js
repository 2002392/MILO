...
handler.before = async function (m, { user, isBotAdmin, isAdmin }) {
  ...
  if (chat.antiLink && isGroupLink) {
    await m.reply(`*「 ANTI LINKS 」*\nTe *vas a la verga con tu spam att el bot Danery siuu el mejor XD👋, ${await this.getName(m.sender)} rompiste las reglas serás exterminado....!!*`)
    ...
    if (isgclink) return m.reply('*Lol.. enviaste el enlace de este grupo pero compartelo en otros para tener mas espermas ganadores XD:v*')
