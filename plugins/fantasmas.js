...
let handler = async (m, { conn, text, participants }) => {
	...
	conn.reply(m.chat, `*[ REVISIÓN DE INACTIVOS HABRA LIMPIEZA PRONTO ]*\n\n*Grupo: ${conn.getName(m.chat)}*\n*Participantes: ${sum}*\n\n*[ 👻 LISTA DE FANTASMAS ANALIZADOS POR DANERYBOT HAMMA XD 👻 ]*\n${sider.map(v => '  👉🏻 @' + v.replace(/@.+/, '')).join('\n')}\n\n*Nota: Estos numero tienen el contador de mensajes muy bajos*`, m,{ contextInfo: { mentionedJid: sider } })
}
